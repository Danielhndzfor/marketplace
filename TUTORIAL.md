...
```sh
docker exec -it marketplace20-web-service-1 sh
```

> **NOTA**  
> El nombre del contenedor (`marketplace20-web-service-1`) puede cambiar dependiendo
